...
import com.example.quiz.databinding.ViewholderQuestionBinding
...
class QuestionAdapter (
    ...
    override fun onBindViewHolder(holder: QuestionAdapter.Viewholder, position: Int) {
        ...
        if(differ.currentList.size==5 && currentPos==position){
            binding.answerTxt.setBackgroundResource(R.drawable.green)
        ...
        if(differ.currentList.size==5){
            ...
            if(clickedPos==position && clickedPos!=currentPos){
                binding.answerTxt.setBackgroundResource(R.drawable.red)
                binding.answerTxt.setTextColor(
                    ContextCompat.getColor(binding.root.context,
                        R.color.white
                    )
